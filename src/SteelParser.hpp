...
// SteelParser.hpp generated by trison
// from SteelParser.trison using trison.cpp.targetspec and trison.cpp.header.codespec
// DO NOT MODIFY ! DO NOT MODIFY ! DO NOT MODIFY ! DO NOT MODIFY ! DO NOT MODIFY
...
/// this file was generated.  Specifically, the primary source is SteelParser.trison.
///
...
public:
    ...
    /// "Namespace" for SteelParser::Nonterminal::Name, which enumerates all nonterminals.
    ...
    struct Nonterminal
    {
        ...
        enum Name
        {
            ...
            vardecl = 313,
            param_list = 314
        }; // end of enum SteelParser::Nonterminal::Name
    }; // end of struct SteelParser::Nonterminal
...
private:
    ...
    struct Grammar_
    {
        ...
        struct Precedence_
        {
            ...
            char const *    m_name;
        }; // end of struct SteelParser::Grammar_::Precedence_
    ...
    }; // end of struct SteelParser::Grammar_
    ...
    struct Npda_
    {
        ...
        struct State_
        {
            ...
            char const *        m_description;
        }; // end of struct SteelParser::Grammar_::State_
        ...
        struct Transition_
        {
            ...
            }; // end of struct SteelParser::Grammar_::Transition_::Order
        }; // end of struct SteelParser::Grammar_::Transition_
    ...
    }; // end of struct SteelParser::Npda_
    ...
    private:
        ...
        {
            // If this is a Terminal (anything between 0 and Terminal::BIN_NOT)
            // that isn't ERROR_, then it's scanner-generated (i.e. not parser-generated).
            return token_id != Terminal::ERROR_ && token_id <= Terminal::BIN_NOT;
        }
    ...
    }; // end of struct SteelParser::HypotheticalState_
    ...
    struct ParseTreeNode_
    {
        ...
        struct Spec
        {
            ...
            }; // end of struct SteelParser::ParseTreeNode_::Spec::Order
        }; // end of struct SteelParser::ParseTreeNode_::Spec
        ...
        Token::Id LookaheadTokenId (SteelParser &parser) const;
        ...
        void Print (std::ostream &out, SteelParser const *parser, std::string const &prefix, std::uint32_t indent_level = 0, bool suppress_initial_prefix = false) const;
    }; // end of struct SteelParser::ParseTreeNode_
    ...
    friend std::ostream &operator << (std::ostream &stream, SteelParser::ParserReturnCode parser_return_code);
